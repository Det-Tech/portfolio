<template>
  ...
  <div :class="`main-menu-parent grid grid-cols-${sizeBiggerGrid-1} grid-rows-1`">
    ...
    <div class="page-background">
      ...
      <img src="https://raw.githubusercontent.com/Det-tech/portfolio/master/static/profile-head.png" name='moi' class="w-52 rounded-full mx-auto pt-12 pb-2">
      ...
      <div class="flex flex-col space-y-0">
        ...
        <LetterAnimation
          :text="'Front-end. Back-end. Blockchain'"
      ...
      <div class="mx-auto scroll-arrow" @click="scrollto('about')" :style="`opacity: ${scrollArrow.opacity};`" >
          ...
          <div class="flex flex-row justify-center animate-bounce">
            <div class="px-2" v-for="i in 2" :key="i">
              <img src="https://raw.githubusercontent.com/Det-tech/portfolio/master/static/icons/Icon_arrow_down.png"
                class="w-6">
            </div>
          </div>
      </div>
